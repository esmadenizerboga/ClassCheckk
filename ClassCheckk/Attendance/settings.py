...
SECRET_KEY = 'django-insecure-z4zcl5_=!kk9@u$r++&76ac=8)hr3$c_)(x)40f6#jbnopx2+t'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / "Attendance"/"RollCall"/"static",  # Projenizde 'static' klasörü oluşturun
    os.path.join(BASE_DIR, "photos"),  # photos klasörünü static olarak tanımla
]
